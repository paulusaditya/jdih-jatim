            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                <div className="g-recaptcha" data-sitekey="your_recaptcha_site_key">
                  {/* This is a placeholder for the actual reCAPTCHA */}
                  <div className="flex items-center border border-gray-300 rounded p-2 bg-white w-fit">
                    ...
                    <img src="/RecaptchaLogo.png?height=40&width=40" alt="reCAPTCHA logo" className="ml-4 h-10 w-10" />
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 md:p-8">
          ...
          <div className="space-y-6">
            <div className="flex">
              ...
              <div className="ml-4">
                <h3 className="text-sm font-medium text-gray-900">Alamat Kami:</h3>
            ...
            <div className="flex">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-sm text-gray-600">031-3520881 031-3524001 (Psw. 1118)</p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-sm text-gray-600">
                  <a href="mailto:support@jdih.jatimprov.go.id" className="hover:underline">
            ...
            <div className="flex">
              ...
              <div className="ml-4">
                <h3 className="text-sm font-medium text-gray-900">Jam Kerja:</h3>
                <p className="mt-1 text-sm text-gray-600">Senin s/d Jumat 08:00 - 16:00 WIB</p>
              </div>
            </div>
          </div>
        </div>
