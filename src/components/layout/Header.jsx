          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-2 sm:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-3 space-y-2 sm:space-y-0">
              ...
              <a
                ...
                className="flex items-center bg-green-800 text-white text-xs px-2 py-1.5 rounded space-x-1 hover:bg-green-900 transition-colors w-fit"
              >
...
function NavBar({ isSidebarOpen, setSidebarOpen, navItems }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-x-4 xl:gap-x-8 text-green-800">
      {navItems.map((item, index) => (
        <div key={index} className="relative dropdown-container group">
          {item.sub_menus.length > 0 ? (
            <span
              className={`hover:font-semibold cursor-pointer inline-flex items-center py-2 text-sm lg:text-base transition-colors ${
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:font-semibold inline-flex items-center py-2 text-sm lg:text-base transition-colors"
            >
              {item.title}
            ...
            <Link
              ...
              className={`hover:font-semibold inline-block py-2 text-sm lg:text-base transition-colors ${
                isActive(item.link) ? "font-bold text-green-900" : ""
              }`}
            >
              {item.title}
          ...
          {item.sub_menus.length > 0 && (
            <div className="absolute left-0 top-full z-50 w-max min-w-[250px] max-w-[300px] hidden group-hover:block">
  ...
  return (
    <>
      ...
      <div
        ...
        } transition-transform duration-300 ease-in-out z-50 lg:hidden overflow-y-auto max-h-screen`}
      >
        {/* Sidebar Header */}
