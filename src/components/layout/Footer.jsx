      ...
      <div className="bg-green-800 text-white py-15 px-4 md:px-8 md:pt-60 pt-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="hidden md:grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4">
                Kantor Biro Hukum Sekretariat Daerah Provinsi Jawa Timur.
              </h3>
              <p className="text-sm mb-4">
                Lantai 4 Gedung Sekretariat Daerah Provinsi Jawa Timur.
                <br />
                Jl.Pahlawan No.110, Alun-alun Contong, Bubutan, Surabaya 60174,
                Jawa Timur
              </p>
              
              <h3 className="text-lg font-semibold mb-4 mt-10">Sitemap</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4">
                Perpustakaan Hukum Biro Hukum Sekretariat Daerah Provinsi Jawa
                Timur
              </h3>
              <p className="text-sm mb-4">
                Lantai 1 Gedung Kantor Gubernur Jawa Timur
                <br />
                Jl. Pahlawan No.110, Alun-alun Contong, Bubutan, Surabaya 60174,
                Jawa Timur.
              </p>
              
              <h3 className="text-lg font-semibold mb-4 mt-8">Analytics</h3>
              <ul className="space-y-2">
            ...
            <div>
              ...
              <p className="text-sm mb-4">support@jdih.jatimprov.go.id</p>

              <h3 className="text-lg font-semibold mb-4 mt-25">Media Sosial</h3>
          ...
          <div className="md:hidden space-y-8 mb-12">
            ...
            {/* 2. Perpustakaan Hukum Address */}
            <div>
              <h3 className="text-lg font-semibold mb-4">
                Perpustakaan Hukum Biro Hukum Sekretariat Daerah Provinsi Jawa Timur
              </h3>
              <p className="text-sm">
                Lantai 1 Gedung Kantor Gubernur Jawa Timur
                <br />
