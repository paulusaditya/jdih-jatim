      ...
      <div className="bg-blue-950 text-white py-15 px-4 md:px-8 pt-65">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <div className="flex space-x-4 gap-4">
                <a href="https://www.tiktok.com/@jdihjatim" target="_blank" rel="noopener noreferrer" className="hover:text-blue-300">
                  <SiTiktok size={24} />
                </a>
                <a href="https://twitter.com/jdihjatim" target="_blank" rel="noopener noreferrer" className="hover:text-blue-300">
                  <Twitter size={24} />
                </a>
                <a href="https://www.instagram.com/jdihjatim" target="_blank" rel="noopener noreferrer" className="hover:text-blue-300">
                  <Instagram size={24} />
                </a>
                <a href="https://www.youtube.com/jdihjatim" target="_blank" rel="noopener noreferrer" className="hover:text-blue-300">
                  <Youtube size={24} />
                </a>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12 border-t border-blue-900 pt-8">
            ...
            {/* Sitemap -> Diposisikan di bawah Kantor Biro Hukum */}
            <div>
              <h3 className="text-lg font-semibold mb-4">Sitemap</h3>
              <ul className="space-y-2">
                <li><Link to="/">Home</Link></li>
                <li><Link to="/profil">Profil</Link></li>
                <li><Link to="/produk-hukum">Produk Hukum</Link></li>
                <li><Link to="/dokumen-hukum-lainnya">Dokumen Hukum Lainnya</Link></li>
                <li><Link to="/berita">Berita</Link></li>
                <li><Link to="/survey">Survey</Link></li>
              </ul>
            </div>

            {/* Analytics -> Sejajar dengan Customer Support */}
            <div>
